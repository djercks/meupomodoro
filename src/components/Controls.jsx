export default function Controls({ running, onToggle, onReset, onFinish }) {
  return (
    <div className="flex items-center gap-3">
      ...
      <button
        ...
        className="glass text-white/80 font-semibold uppercase tracking-wide text-xs px-4 py-3.5 rounded-full flex items-center gap-1.5 hover:bg-white/10 transition"
      >
      ...
      <button
        ...
        className="w-12 h-12 rounded-full glass flex items-center justify-center hover:bg-white/10 transition flex-shrink-0"
      >
